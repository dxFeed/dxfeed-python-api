...
ProfileTuple = namedtuple('Profile', ['symbol', 'beta', 'eps', 'div_freq', 'exd_div_amount', 'exd_div_date',
                                      'high_52_week_price', 'low_52_week_price', 'shares', 'free_float', 'high_limit_price',
    ...
    with gil:
        ...
        for i in range(data_count):
            events[i] = ProfileTuple(symbol=unicode_from_dxf_const_string_t(symbol_name),
                                     ...
                                     high_52_week_price=p[i].high_52_week_price,
                                     low_52_week_price=p[i].low_52_week_price,
                                     shares=p[i].shares,
